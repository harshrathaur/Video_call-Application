...
public class RegistrationActivity extends AppCompatActivity {
    ...
    private PhoneAuthProvider.ForceResendingToken mRecentToken;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        continueAndNextBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if(continueAndNextBtn.getText().equals("Submit") || checker.equals("Code Sent"))
                {
                    ...
                    {
                        Toast.makeText(RegistrationActivity.this,"Please Write code First ",Toast.LENGTH_SHORT).show();
                    }
                    else
                    {
                ...
                else
                {
                    ...
                    {
                        Toast.makeText(RegistrationActivity.this,"Please write valid number",Toast.LENGTH_SHORT).show();
                    }
                }
            }
        });
        ...
        mCallbacks=new PhoneAuthProvider.OnVerificationStateChangedCallbacks() {
            ...
            Toast.makeText(RegistrationActivity.this,"Invalid Phone Number :"+e,Toast.LENGTH_SHORT).show();
            ...
            public void onCodeSent(String s, PhoneAuthProvider.ForceResendingToken forceResendingToken) {
                ...
                mVerificationId = s;
                mRecentToken=forceResendingToken;
    ...
    protected void onStart() {
        ...
        if(firebaseUser!=null){
            Intent intentHome = new Intent(RegistrationActivity.this, ContactsActivity.class);
